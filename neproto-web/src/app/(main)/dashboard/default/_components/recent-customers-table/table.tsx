...
export function RecentCustomersTable({ data, locale }: { data: RecentCustomerRow[]; locale: AppLocale }) {
  const messages = APP_MESSAGES[locale].dashboard.table;
  const columns = React.useMemo(() => createRecentCustomersColumns(locale), [locale]);
  const statusOptions = [
    { value: "all", label: messages.all },
    { value: "Subscribed", label: messages.subscribed },
    { value: "Inactive", label: messages.inactive },
    { value: "Unsubscribed", label: messages.unsubscribed },
  ] as const;
  const billingOptions = [
    { value: "all", label: messages.all },
    { value: "Paid", label: messages.paid },
    { value: "Pending", label: messages.pending },
    { value: "Overdue", label: messages.overdue },
    { value: "Trial", label: messages.trial },
  ] as const;
  const joinedDateOptions = [
    { value: "all", label: messages.allTime },
    { value: "30", label: messages.last30Days },
    { value: "90", label: messages.last90Days },
  ] as const;
  const sortOptions = [
    { value: "newest", label: messages.newestFirst },
    { value: "oldest", label: messages.oldestFirst },
    { value: "name-asc", label: messages.nameAscending },
    { value: "name-desc", label: messages.nameDescending },
  ] as const;
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-1">
        <div className="hidden flex-1 text-muted-foreground text-sm lg:flex">
          {table.getFilteredSelectedRowModel().rows.length} {messages.of} {table.getFilteredRowModel().rows.length}{" "}
          {messages.selected}.
        </div>
        <div className="flex w-full items-center gap-8 lg:w-fit">
          ...
          <div className="flex w-fit items-center justify-center font-medium text-sm">
            {messages.page} {table.getState().pagination.pageIndex + 1} {messages.of} {table.getPageCount()}
          </div>
          <div className="ml-auto flex items-center gap-2 lg:ml-0">
            ...
            >
              <span className="sr-only">{messages.firstPage}</span>
            ...
            <Button
              ...
              disabled={!table.getCanNextPage()}
            >
              <span className="sr-only">{messages.lastPage}</span>
