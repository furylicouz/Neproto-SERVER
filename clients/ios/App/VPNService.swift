            ...
            try session.sendProviderMessage(Data("np2-diagnostics".utf8)) { [weak self] response in
                ...
                DispatchQueue.main.async {
                    ...
                    let fields = [
                        ...
                        "quic_min_rtt_ms", "quic_latest_rtt_ms", "quic_smoothed_rtt_ms", "quic_rtt_deviation_ms",
                        "quic_bytes_sent", "quic_packets_sent", "quic_bytes_received", "quic_packets_received",
                        "quic_bytes_lost", "quic_packets_lost",
